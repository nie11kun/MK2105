...
|:----:|:----:|:----:|
|**PLC_NC交换变量**|
|$A_IN[0]|DB4900.DBX0.0|是否修整
|$A_IN[1]|DB4900.DBX1.0|是否手动对刀
|$A_IN[2]|DB4900.DBX2.0|是否退刀，异步动作信号
|$A_IN[3]|DB4900.DBX3.0|液压动作回退到位
|$A_IN[4]|DB4900.DBX4.0|液压动作伸出到位
|$A_IN[5]|DB4900.DBX5.0|是否自动对刀
|$A_IN[6]|DB4900.DBX6.0|C轴旋转
|$A_IN[7]|DB4900.DBX7.0|自动对刀测量机构1汽缸回退到位
|$A_IN[8]|DB4900.DBX8.0|自动对刀测量机构1汽缸伸出到位
|$A_IN[9]|DB4900.DBX9.0|自动门打开开关
|$A_IN[10]|DB4900.DBX10.0|自动门关闭开关
|$A_IN[11]|DB4900.DBX11.0|
|$A_IN[12]|DB4900.DBX12.0|砂轮当前状态(0停止/1启动)
|$A_IN[13]|DB4900.DBX13.0|修整轮当前状态(0停止/1启动)
|$A_IN[14]|DB4900.DBX14.0|升角夹紧动作检测信号(0未松开/1已松开)
|$A_IN[15]|DB4900.DBX15.0|
...
|$A_IN[23]|DB4900.DBX23.0|液压修整器回退到位
|$A_IN[24]|DB4900.DBX24.0|液压修整器伸出到位
|||与桁架机器人交互相关的信号

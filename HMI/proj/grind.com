...
//M(Mask18/$85020//)
	...
	DEF JIAJU_SHALUN=(I/0,//$85149,$85149,,/WR2,ac4//"$R[101]"/10,230,202/110,230,60//);砂轮转速
	DEF JIAJU_YOUDUAN=(R///$85150,$85150,,/WR2,ac4//"$R[102]"/10,260,202/110,260,60//);磨削右端z
	DEF JIAJU_ZUODUAN=(R///$85151,$85151,,/WR2,ac4//"$R[103]"/10,280,202/110,280,60//);磨削左端z
	DEF JIAJU_QIDIAN=(R///$85152,$85152,,/WR2,ac4//"$R[104]"/10,310,202/110,310,60//);磨削起点x
	DEF JIAJU_JINDAO=(R///$85153,$85153,,/WR2,ac4//"$R[105]"/10,330,202/110,330,60//);进刀量
	DEF JIAJU_SUDU=(R///$85154,$85154,,/WR2,ac4//"$R[106]"/10,350,202/110,350,60//);磨削速度
	...
	DEF CLEAN_INTER=(I/0,//$85131,$85131,,/WR2,ac4//"/NC/_N_NC_GD2_ACX/INI[13]"/10,110,202/130,110,60//);清理间隔天数
	DEF CLEAN_RESET=(I/*0=$85123,1=$85143//$85132,$85132,,/WR2,ac4//"/NC/_N_NC_GD2_ACX/INI[14]"/10,130,202/130,130,60//);重置清理离心机日期
	DEF CLEAN_ALARM=(I/*0=$85140,1=$85141//$85133,$85133,,/WR2,ac4//"/NC/_N_NC_GD2_ACX/INI[168]"/10,150,202/130,150,60//);清理离心机是否报警提示(0否1是)
